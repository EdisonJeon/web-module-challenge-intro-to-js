...
console.log("@@@ Prior to Change @@@: ", compChoice);
console.log("@@@ type @@@: ", typeof(compChoice));
if (compChoice === 0) {
  compChoice = "rock"
...
console.log("@@@ After change @@@" ,compChoice);
console.log("@@@ type @@@: ", typeof(compChoice));
...
function annoyingSong(num){
  return (
    `${num} bottles of soda on the wall, ${num} bottles of soda, take one down pass it around ${num - 1} bottles of soda on the wall`
  )
}
...
console.log("stretch: ", vowelCounter("edison"));
